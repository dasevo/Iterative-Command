...
public class RobotMap {
	...
	public static SpeedControllerGroup right = new SpeedControllerGroup(oneR, threeR);
	public static SpeedControllerGroup left = new SpeedControllerGroup(twoL, fourL);
